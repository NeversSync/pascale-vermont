...
import { PalliativeWrapper, GriefTitle, GriefSvg, GriefLine, GriefTestimonial, GriefImgWrapper, GriefTitleWrapper, GriefCopy } from '../styles/grief-styles';
import { HomeButton, Spacer, ImageWrapper, Copy, Card } from '../components/Helpers';

const IndexPage = () => (
  <PalliativeWrapper style={{ borderBottom: 'none' }}>
    <GriefTitleWrapper>
      <GriefTitle>PALLIATIVE CARE SUPPORT</GriefTitle>
      <GriefSvg>
    ...
    <GriefCopy>
      ...
      <li>Volunteer and instructor for San Francisco Crisis Care working in partnership with law enforcement officials and providing emotional support and practical assistance to families after a sudden death.</li><br/>
